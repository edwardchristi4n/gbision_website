...
const QUICK_ACCESS = [
  ...
  },
  {
    ...
    desc: "Tonton khotbah terbaru",
    to: "/jadwal",
  },
  {
    icon: "🤝",
    title: "Layanan Gereja",
    desc: "Baptisan, doa, konseling",
    to: "/tentang",
  },
  {
    icon: "📍",
...
const programs = [
  {
    icon: "🙏",
    title: "Kelompok Sel",
    desc: "Komunitas kecil yang hangat untuk bertumbuh dalam iman dan persahabatan.",
    bg: "#FEF0E8",
  },
  {
    icon: "🎵",
    title: "Pelayanan Musik",
    desc: "Melayani Tuhan melalui pujian dan penyembahan bersama tim worship.",
    bg: "#E8F4FD",
  },
  {
    icon: "👶",
    title: "Sekolah Minggu",
    desc: "Program anak menyenangkan agar si kecil bertumbuh kenal Tuhan.",
    bg: "#E8F8F0",
  },
];
...
const announcements = [
  {
    ...
    tagColor: "#E8541A",
    tagBg: "#FEF0E8",
    title: "Ibadah Natal Bersama 25 Desember 2025",
    desc: "Rayakan kelahiran Yesus bersama seluruh jemaat GBI Sion Karawang.",
    date: "Des 25, 2025",
    pinned: true,
  },
  {
    ...
    tagColor: "#1A3A5C",
    tagBg: "#E8F0F8",
    title: "Pendaftaran Kelompok Sel Semester 2 Dibuka",
    desc: "Daftarkan diri ke kelompok sel terdekat mulai minggu ini.",
    date: "Nov 10, 2025",
    pinned: false,
  },
  {
    ...
    tagColor: "#0F6E56",
    tagBg: "#E8F8F0",
    title: "Youth Camp 2025 — Daftar Sekarang!",
    desc: "Acara tahunan youth camp di Puncak, Bogor. Tempat terbatas!",
    date: "Nov 5, 2025",
    pinned: false,
  },
];
...
const GALLERY = [
  {
    label: "Ibadah Raya 2024",
    bg: "linear-gradient(135deg,#1E4A7A,#0D2240)",
    span: true,
  },
  {
    label: "Natal 2024",
    bg: "linear-gradient(135deg,#E8541A,#C94010)",
    span: false,
  },
  {
    label: "Baptisan",
    bg: "linear-gradient(135deg,#2A6BAD,#1A3A5C)",
    span: false,
  },
  {
    label: "Youth Camp",
    bg: "linear-gradient(135deg,#FF8C5A,#E8541A)",
    span: false,
  },
  {
    label: "Outreach",
    bg: "linear-gradient(135deg,#0D2240,#1E4A7A)",
    span: false,
  },
];
...
function AnimatedCounter({ to, suffix }: { to: number; suffix: string }) {
  ...
  useEffect(() => {
    ...
    const ctrl = animate(0, to, {
      ...
      onUpdate(v) {
        setDisplay(
          to >= 1000 ? (v / 1000).toFixed(1) + "K" : Math.round(v).toString(),
        );
      },
    });
    return ctrl.stop;
  ...
  return (
    ...
    >
      {display}
      <span style={{ color: "#E8541A" }}>{suffix}</span>
    </div>
  );
}
    ...
    <div style={{ fontFamily: "'Plus Jakarta Sans',sans-serif" }}>
      <style>{`
        ...
        .photo-marquee-track {
          ...
          width:max-content; animation:photoMarqueeScroll 40s linear infinite;
        }
        .photo-marquee-track:hover { animation-play-state:paused; }
        .photo-marquee-img {
          height: 240px; width: 320px; object-fit: cover; border-radius: 12px;
          transition: transform 0.4s ease; cursor: pointer;
          box-shadow: 0 8px 24px rgba(0,0,0,0.3);
        }
        .photo-marquee-img:hover { transform: scale(1.05); }
      ...
      >
        {/* Background Video using YouTube */}
        <div style={{ position: "absolute", inset: 0, zIndex: 0, pointerEvents: "none", overflow: "hidden" }}>
          <iframe
            src="https://www.youtube.com/embed/k41uW7tP9uA?autoplay=1&mute=1&controls=0&loop=1&playlist=k41uW7tP9uA&playsinline=1&rel=0&modestbranding=1"
          ...
          />
          {/* Dark Glass Overlay untuk Premium Look & Accessibility */}
          <div style={{
            position: "absolute",
            inset: 0,
            background: "linear-gradient(135deg, rgba(13, 34, 64, 0.75) 0%, rgba(10, 27, 51, 0.9) 100%)",
        ...
        >
          ...
          >
            Bergabunglah bersama keluarga besar GBI Sion Karawang — komunitas,
            pertumbuhan rohani, dan pelayanan penuh makna.
          </motion.p>
          ...
          >
            <NavLink to="/jadwal" style={{ textDecoration: "none" }}>
              <button className="hero-cta-primary">
                Jadwal Ibadah <ArrowRight size={16} aria-hidden="true" />
              </button>
            </NavLink>
            <NavLink to="/kontak" style={{ textDecoration: "none" }}>
              <button className="hero-cta-outline">Lokasi & Kontak</button>
            </NavLink>
          </motion.div>
        </motion.div>
          ...
          {[...MARQUEE_ITEMS, ...MARQUEE_ITEMS].map((item, i) => (
            <span
              ...
              style={{
                ...
                letterSpacing: "2px",
                textTransform: "uppercase",
                color: item === "✦" ? "#E8541A" : "rgba(255,255,255,.65)",
                padding: item === "✦" ? "0 10px" : "0 24px",
              }}
            >
              {item}
            </span>
      ...
      >
        <div className="photo-marquee-track" aria-hidden="true">
          {[
            "https://images.unsplash.com/photo-1438283173091-5dbf5c5a3206?w=800&q=80", // Gereja / Worship
            "https://images.unsplash.com/photo-1544427920-c49ccfb85579?w=800&q=80", // Komunitas
            "https://images.unsplash.com/photo-1511632765486-a01980e01a18?w=800&q=80", // Teman / Pemuda
            "https://images.unsplash.com/photo-1490730141103-6cac27aaab94?w=800&q=80", // Acara
            "https://images.unsplash.com/photo-1510590337019-5ef8d3d32116?w=800&q=80", // Tangan berdoa
            ...
            <img key={i} src={src} alt={`Church moment ${i}`} className="photo-marquee-img" loading="lazy" />
          ))}
        </div>
      </div>
            ...
            <motion.div key={item.title} variants={fade}>
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{ fontSize: 12.5, color: "#888", lineHeight: 1.5 }}
                  >
                    {item.desc}
                  </div>
                  <span
      ...
      <section className="home-section" style={{ background: "#fff" }}>
        <div className="home-inner">
          ...
          <motion.div
            ...
            variants={staggerWrap(0.05)}
            className="home-photo-grid"
          >
            {/* Tall card */}
            <motion.div
              variants={fadeL}
              className="photo-card photo-tall"
              style={{
                gridRow: "span 2",
                borderRadius: 16,
                overflow: "hidden",
                position: "relative",
                background: "linear-gradient(160deg,#1E4A7A,#0D2240)",
              }}
            >
              <div
                style={{
              ...
              >
                <span style={{ fontSize: 56, opacity: 0.12, color: "#fff" }} aria-hidden="true">
                  ⛪
                </span>
              </div>
              <div
            ...
            {[
              ...
              {
                label: "GBI Kids",
                bg: "linear-gradient(135deg,#D4A843,#b8892e)",
                emoji: "👶",
              },
              {
                label: "Youth & Pemuda",
              ...
              >
                ...
                >
                  <span style={{ fontSize: 36, opacity: 0.15, color: "#fff" }}>
                    {c.emoji}
                  </span>
                </div>
                <div
            ...
            >
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "linear-gradient(160deg,#1A3A5C 0%,#0D2240 60%,rgba(232,84,26,.3) 100%)",
                }}
              />
              <motion.div
                style={{
              ...
              <div style={{ position: "relative", zIndex: 1 }}>
                ...
                >
                  Dalami firman Tuhan bersama pengajar berpengalaman setiap
                  minggu pagi.
                </p>
                <div
                  style={{
            ...
            {GALLERY.map((g, i) => (
              <motion.div
                ...
                style={{
                  ...
                  position: "relative",
                  cursor: "pointer",
                  gridColumn: g.span ? "span 2" : undefined,
                  gridRow: g.span ? "span 2" : undefined,
                  minHeight: 160,
                }}
              >
                <div
      ...
      >
        <div
          style={{
            ...
            height: 320,
            background:
              "radial-gradient(circle,rgba(232,84,26,.15),transparent 70%)",
            pointerEvents: "none",
          }}
        />
        <div
          style={{
            ...
            height: 240,
            background:
              "radial-gradient(circle,rgba(212,168,67,.08),transparent 70%)",
            pointerEvents: "none",
          }}
        />
        ...
        >
          ...
          >
            Jadilah Bagian dari{" "}
            <em style={{ fontStyle: "normal", color: "#E8541A" }}>Keluarga</em>{" "}
            Ini
          </motion.h2>
          <motion.p
            variants={fade}
