        ...
        <div className="sched-inner">
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:48, alignItems:"center" }}>
            <motion.div initial="hidden" whileInView="show" viewport={{ once:true, margin:"-60px" }} variants={staggerWrap()}>
              ...
              <motion.div variants={fade}>
                <a href="#" style={{ textDecoration:"none" }}>
                  <button className="btn-primary">Tonton Live Streaming →</button>
                </a>
              </motion.div>
            </motion.div>
            ...
            <motion.div initial={{ opacity:0, scale:0.96 }} whileInView={{ opacity:1, scale:1 }} transition={{ duration:0.6 }} viewport={{ once:true }}
              style={{ borderRadius:20, overflow:"hidden", position:"relative", background:"linear-gradient(135deg,#0D2240,#1A3A5C)", minHeight:320, display:"flex", alignItems:"center", justifyContent:"center" }}>
              <div style={{ position:"absolute", inset:0, backgroundImage:"radial-gradient(ellipse 60% 50% at 60% 40%,rgba(232,84,26,.2),transparent 60%)" }} />
              <div style={{ textAlign:"center", position:"relative", zIndex:1 }}>
                <div style={{ width:72, height:72, borderRadius:"50%", background:"rgba(232,84,26,.9)", display:"flex", alignItems:"center", justifyContent:"center", margin:"0 auto 16px", boxShadow:"0 0 0 12px rgba(232,84,26,.15),0 0 0 24px rgba(232,84,26,.07)" }}>
                  <span style={{ fontSize:28, marginLeft:4 }}>▶</span>
                </div>
                <div style={{ fontSize:15, fontWeight:700, color:"#fff", marginBottom:4 }}>Live Streaming</div>
                <div style={{ fontSize:12, color:"rgba(255,255,255,.5)" }}>YouTube · Setiap Minggu</div>
              </div>
            </motion.div>
          </div>
        </div>
